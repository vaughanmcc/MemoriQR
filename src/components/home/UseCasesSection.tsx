        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative group">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg bg-memorial-cream">
              {/* Replace with real image: /images/gravestone-qr.jpg */}
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-stone-200 to-stone-300">
                <div className="text-center p-6">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-lg bg-stone-400/50 flex items-center justify-center">
                    <svg className="w-8 h-8 text-stone-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <p className="text-stone-600 font-medium">Gravestone with QR Code</p>
                  <p className="text-stone-500 text-sm mt-1">Image placeholder</p>
                </div>
              </div>
