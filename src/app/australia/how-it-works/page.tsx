...
const orderSteps = [
  {
    ...
    step: 'Step 1',
    description: 'Select your memorial package – Standard, Headstone, or Premium with NFC tag, QR plate, or both.',
    icon: ShoppingCart,
  },
  {
    title: 'Complete Payment',
    step: 'Step 2',
    description: 'Secure checkout via Stripe. All prices are one-time payments in AUD with no hidden fees or subscriptions.',
    icon: CreditCard,
  },
  {
  ...
  },
  {
    ...
    step: 'Step 5',
    description: 'Your premium Metalphoto® QR plate or NFC tag ships from NZ and arrives within 7-10 business days across Australia.',
    icon: Truck,
  },
  {
...
const productTypes = [
  {
    ...
    icon: Smartphone,
    features: ['Instant tap access', 'Works with all modern smartphones', 'Compact & discreet', 'Ships to all Australian states'],
...
export default function AustraliaHowItWorksPage() {
  return (
    <>
      <Header />
      <main>
          ...
          <div className="container-wide">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Share memories with a beautifully crafted QR plate or NFC tag, delivered to your door across Australia
              </p>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container-wide">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                One-time payment in AUD. No subscriptions. No hidden fees.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="border border-gray-200 rounded-2xl p-8 text-center">
                <h3 className="text-xl font-serif text-gray-900 mb-2">Standard</h3>
                <p className="text-sm text-primary-600 font-medium mb-4">NFC Tag Only</p>
                <div className="text-4xl font-bold text-gray-900 mb-2">A$149</div>
                <p className="text-gray-500 text-sm mb-6">5-year hosting</p>
                <ul className="text-left space-y-2 text-gray-600 mb-6">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-memorial-sage" />
                    <span>20 curated photos</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-memorial-sage" />
                    <span>2 videos</span>
              ...
              <div className="border-2 border-primary-500 rounded-2xl p-8 text-center relative">
                ...
                <h3 className="text-xl font-serif text-gray-900 mb-2">Headstone</h3>
                <p className="text-sm text-primary-600 font-medium mb-4">QR Plate Only</p>
                <div className="text-4xl font-bold text-gray-900 mb-2">A$199</div>
                <p className="text-gray-500 text-sm mb-6">10-year hosting</p>
                <ul className="text-left space-y-2 text-gray-600 mb-6">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-memorial-sage" />
                    <span>40 curated photos</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-memorial-sage" />
                    <span>3 videos</span>
              ...
              {/* Premium */}
              <div className="border border-gray-200 rounded-2xl p-8 text-center">
                <h3 className="text-xl font-serif text-gray-900 mb-2">Premium</h3>
                <p className="text-sm text-primary-600 font-medium mb-4">NFC Tag + QR Plate</p>
                <div className="text-4xl font-bold text-gray-900 mb-2">A$279</div>
                <p className="text-gray-500 text-sm mb-6">10-year hosting</p>
                <ul className="text-left space-y-2 text-gray-600 mb-6">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-memorial-sage" />
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-memorial-sage" />
                    <span>Both tag types included</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-sm text-gray-500 mt-4">
                Prices in AUD • Ships from New Zealand
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-wide">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-memorial-cream rounded-2xl p-8">
                ...
                <p className="text-gray-600">
                  No subscriptions, no monthly fees, no surprises. Pay once for 5 or 10 years of hosting. Pricing is clear and upfront in Australian dollars.
                </p>
              </div>
              ...
              <div className="bg-memorial-cream rounded-2xl p-8">
                ...
                <p className="text-gray-600">
                  We ship to Sydney, Melbourne, Brisbane, Perth, Adelaide, and all Australian states and territories. Expect delivery within 7-10 business days.
                </p>
              </div>
            </div>
