          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
              <p className="text-blue-800 mb-0">
                ...
                <Link href="/privacy-summary" className="text-blue-600 hover:text-blue-800 underline">
            ...
            <p>We respect your privacy and do not sell your personal information. We share information only when necessary:</p>
            ...
            <h3>Order Records</h3>
            <p>Purchase history and customer information retained for 7 years for tax and accounting purposes.</p>

            <h2>7. Your Privacy Rights</h2>
            <p>Under New Zealand&apos;s Privacy Act 2020 and GDPR (for European visitors), you have the right to:</p>
            ...
            <ul>
              <li>MemoriQR operates from New Zealand</li>
            ...
            <ul>
              ...
              <li>International transfers comply with applicable privacy laws including GDPR</li>
            </ul>
            ...
            <ul>
              <li><strong>New Zealand residents:</strong> Office of the Privacy Commissioner (<a href="https://www.privacy.org.nz" target="_blank" rel="noopener noreferrer">privacy.org.nz</a>)</li>
