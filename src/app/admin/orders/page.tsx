    ...
    <div className="min-h-screen bg-stone-100">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <nav className="hidden md:flex gap-4 ml-8">
              ...
              <Link href="/admin/orders" className="text-white/90 hover:text-white px-3 py-1 rounded bg-white/10">
                Orders
              </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow p-12 text-center">
          ...
          <h3 className="text-xl font-bold text-stone-800 mb-2">Order Management Coming Soon</h3>
          <p className="text-stone-500 max-w-md mx-auto">
            This page will allow you to view and manage all orders, track fulfillment status, and handle customer inquiries.
          </p>
          <div className="mt-8">
            <Link 
              href="/admin/dashboard" 
