...
<p style="color: #888; font-size: 12px; margin: 0;">MemoriQR Partner Program</p>
    ...
    // Referral code redeemed notification (to partner)
...
${discountPercent > 0 ? `<tr><td style="padding: 12px 20px; color: #6b7280; font-size: 14px;">Customer Discount:</td><td style="padding: 12px 20px; color: #111827; font-size: 14px; font-weight: 600;">${discountPercent}%</td></tr>` : ''}
</table>
